<template>
	<div>
		...
		<div v-if="!props.node && !props.line && !props.multi">
			...
			<div v-if="!getDisabled" class="bottom">
		...
		<div v-if="props.node">
			...
			<div class="items">
				...
				<div class="flex grid">
					<div>
						<el-input-number v-model="props.node.rect.x" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input-number>
					</div>
					<div class="ml5">
						<el-input-number v-model="props.node.rect.y" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input-number>
					</div>
				</div>
			</div>
			<div class="items">
				...
				<div class="flex grid">
					<div>
						<el-input-number v-model="props.node.rect.width" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input-number>
					</div>
					<div class="ml5">
						<el-input-number v-model="props.node.rect.height" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input-number>
					</div>
				</div>
			</div>
			<div class="items" v-if="props.node.is3D">
				...
				<div class="flex grid">
					<div>
						<el-input-number v-model="props.node.z" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input-number>
					</div>
				</div>
			</div>
			<div class="items">
				...
				<div class="flex grid">
					<div>
						<el-input-number v-model="props.node.borderRadius" controls-position="right" @change="onChange" :disabled="getDisabled" :min="0" :max="1" :step="0.1"></el-input-number>
					</div>
					<div class="ml5">
						<el-input-number v-model="props.node.rotate" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input-number>
					</div>
				</div>
			</div>
			<div class="items">
				...
				<div class="flex grid">
					<div>
						<el-input size="small" v-model="props.node.paddingLeft" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input>
					</div>
					<div class="ml5">
						<el-input size="small" v-model="props.node.paddingRight" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input>
					</div>
				</div>
			</div>
			<div class="items">
				...
				<div class="flex grid">
					<div>
						<el-input size="small" v-model="props.node.paddingTop" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input>
					</div>
					<div class="ml5">
						<el-input size="small" v-model="props.node.paddingBottom" controls-position="right" @change="onChange" :disabled="getDisabled"></el-input>
					</div>
				</div>
			</div>
			...
			<div class="items">
				...
				<div class="flex grid">
					<div :class="props.expand ? 'expand-data' : ''">
						<el-input type="textarea" v-model="nodeData" :rows="props.expand ? 15 : 3" @change="onChange" :disabled="getDisabled"></el-input>
					</div>
				</div>
			</div>
		</div>
